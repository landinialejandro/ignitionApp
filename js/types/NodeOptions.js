 ...
 * @property {string} [id] - El ID del nodo.
 * @property {string} caption - El texto del nodo (caption).
 * @property {IconType} icon - Ícono asociado al nodo, puede ser una clase de ícono o un SVG.
